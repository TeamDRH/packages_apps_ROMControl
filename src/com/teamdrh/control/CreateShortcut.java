...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.drh.control.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), DRHControlActivity.class);
        shortcutIntent.setAction("com.drh.control.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("drh_fragment_name", intentClass);
