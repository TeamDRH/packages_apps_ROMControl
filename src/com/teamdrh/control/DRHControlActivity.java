...
public class DRHControlActivity extends PreferenceActivity implements ButtonBarHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getAction().equals("com.drh.control.START_NEW_FRAGMENT")) {
            String className = getIntent().getStringExtra("drh_fragment_name").toString();
            Bundle b = new Bundle();
